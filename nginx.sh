...
sudo openssl req -newkey rsa:2048 -nodes -keyout /etc/openresty/default.key -subj "/C=US/ST=CA/L=San Francisco/O=EA/OU=IT Department/CN=poggers.com" -x509 -days 365 -out /etc/openresty/default.pem
